-- ============================================================
-- Snowkap CBAM
-- P14 remediation (2026-09-04): filing verifies that the population it
-- files is the population that was approved.
--
-- The second of the two independent fixes described in
-- 20260905110000. That migration stops a member reopening an approved
-- shipment; this one means that even if something reopens it, the
-- filing refuses rather than quietly recording a different figure.
--
-- Regenerated in full from the live definition rather than patched, so
-- the text here is the whole function as it will exist.
-- ============================================================
