...
import defaultMethodFixtures from "./fixtures/engine-1.4.0/default-method.json";
import actualMethodFixtures from "./fixtures/engine-1.4.0/actual-method.json";
import emissionUnitFixtures from "./fixtures/engine-1.4.0/emission-units.json";

/**
 * Hand-authored golden fixtures for the calculation engine.
 *
 * Read tests/golden/fixtures/engine-1.4.0/README.md before touching
...
describe(
  "calculation engine goldens (engine 1.4.0)",
  () => {
    it(
