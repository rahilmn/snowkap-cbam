...
describe(
  ...
  () => {
    ...
    it(
      "2026-09-07 (S5 review round 3, finding S5R3-EMPTY-B2): throws on a fetch error rather than degrading to [] -- a false 'no evidence files' on records a producer/importer relies on for verification",
      async () => {
        await expect(
          listEvidenceFiles(
            makeMockSupabase(
